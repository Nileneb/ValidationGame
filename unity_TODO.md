...
{
    [Header("Settings")]
    [SerializeField] private string serverUrl = "http://localhost:8765";
...
- [ ] Android SDK installiert (via Unity Hub)
- [ ] TextMeshPro Package importiert
- [ ] MCP-Server läuft lokal
- [ ] Test-Device verbunden (USB Debugging)
- [ ] Erste Scene erstellt
